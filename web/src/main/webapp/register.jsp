...
<div class="bd_bottom_ea">
    <div class="wrap pub_logo_box clearfix">
        <div class="pub_logo f_l"><a href="/home/index.html"><img alt="" src="pc/www/img/logo.png?v=biyao_4637d54"></a></div>
        <div class="f_r">
...
<div class="wrap">
    <div class="loginItem auto ">
        ...
        <form method="post" action="/register" id="J_phone">
            <div class="loginBox">
                ...
                <%--<dl class="mg_t20">--%>
                    ...
                    <%--<dd class="inline mg_r5"><input type="text"  value="请输入短信验证码"  name="securitycode" id="verificationCode"  class="loginTxt w200 col_999  border" />--%>
                ...
                <dl class="mg_t20">
                    ...
                    <dd class="inline mg_r5">
                        <input type="password" id="passwd1"    value="" name="password"  class="loginTxt w360 col_999 border none"  />
                ...
                <dl class="mg_t20">
                    ...
                    <dd class="inline mg_r5">
                        <input type="password" id="passwd2"  value="" name="confirmPassword"  class="loginTxt w360 col_999 border none" />
                ...
                <input type="submit" class="loginBtns w240 inline t_c mg_t20 none" value="注册"/>
...
<script src="pc/common/js/ui/validate.js?v=biyao_8c8263d"></script>
<script src="pc/common/js/common.js?v=biyao_c83c46d"></script>
<script src="pc/common/js/ui/dialog.js?v=biyao_130c013"></script>
<script src="pc/www/js/mycenter/registNew.js?v=biyao_d929892"></script>
<script src="pc/www/js/login/regval.js?v=biyao_f57c0c6"></script>
<script>
    validateUserName();
    LT.registNew();
    LT.findpassword();
