...
<div class="pd_t10">
    ...
    <div class="home_banner auto"  id="banner_switch">
        ...
        <ul class="home_banner_list sizeZero"   id="banner_switch_list">
            <li class="inline" ><a href="list.html#mknitwear/index.html?f_upd=fb-356" target="_blank" id="bl_image_url" class="inline" style="background: url('files/data0/web/93b66cf221d848798353494bf1fd008c.jpg') center center no-repeat; "></a></li>
            <li class="inline" ><a href="list.html#/socks/index.html?f_upd=fb-365" target="_blank" id="bl_image_url" class="inline" style="background: url('files/data0/web/e586570485a148eab906d840b777554d.jpg') center center no-repeat; "></a></li>
            <li class="inline" ><a href="list.html#/man/index.html?f_upd=fb-319" target="_blank" id="bl_image_url" class="inline" style="background: url('files/data0/web/11-.jpg') center center no-repeat; "></a></li>
            <li class="inline" ><a href="list.html#polo/index.html?f_upd=fb-329" target="_blank" id="bl_image_url" class="inline" style="background: url('files/data0/web/529a480a1da74563a32e73f73b6d0c2d.jpg') center center no-repeat; "></a></li>
        </ul>
    ...
    <div class="feature_info auto">
        <ul class="feature_info_list sizeZero">
            <li class="inline">
                <i class="inline mg_r5"><img src="files/data0/web/96a7cff302474a6a9c12b6462b351db3.png" width="30" height="30" alt="" /></i>
                <span class="inline f18 col_523">直连一线制造
</span>
            </li>
            <li class="inline">
                <i class="inline mg_r5"><img src="files/data0/web/3754469f2abb485eae613e01a7f754e5.png" width="30" height="30" alt="" /></i>
                <span class="inline f18 col_523">7天无忧退换货</span>
            </li>
            <li class="inline">
                <i class="inline mg_r5"><img src="files/data0/web/7aa60b3fef7f4d539013f601a55fbe1c.png" width="30" height="30" alt="" /></i>
                <span class="inline f18 col_523">平台先行赔付</span>
            </li>
            <li class="inline">
                <i class="inline mg_r5"><img src="files/data0/web/9a4a21dfe8914533978d0e848e0b4939.png" width="30" height="30" alt="" /></i>
    ...
    <div class="pd_b40">
        <div class="pd_t30 wrap auto">
            ...
            <div class="banner_con">
                <a href="/goods/queryList?type=1&desc=男"  target="_blank">
                    <img data-original="files/data0/web/d574a255b5544e29ae36084a78f95c32.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=1&desc=T恤"  target="_blank">
                    <img data-original="files/data0/web/2935fa7d409c4dd48c089597eed16002.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=1&desc=牛仔"  target="_blank">
                    <img data-original="files/data0/web/fe8e62b36eda4e17ae8e11b07ac9c022.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=1&desc=裤"  target="_blank">
                    <img data-original="files/data0/web/ccd768f044ad49a48b620d370e6b20c2.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=3&desc=男士户外服"  target="_blank">
                    <img data-original="files/data0/web/797106b3340b43cfb79097ec4d98dae8.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=1&desc=POLO衫"  target="_blank">
                    <img data-original="files/data0/web/4ca60f5a3263400fb0345f3ac25c8285.jpg" width="1200" height="280" alt="" />
                </a>
            </div>
        </div>
        <div class="pd_t30 wrap auto">
            ...
            <div class="banner_con">
                <a href="/goods/queryList?type=2&desc=女裙"  target="_blank">
                    <img data-original="files/data0/web/3df76bce6c1349ef8a9515f23ce8dd54.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=2&desc=女"  target="_blank">
                    <img data-original="files/data0/web/b888c509f239413587d208a4ceb3c65c.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=2&desc=牛仔"  target="_blank">
                    <img data-original="files/data0/web/922e8c283c104a649581cae5fba30166.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=2&desc=户外女"  target="_blank">
                    <img data-original="files/data0/web/853fb145167d42fc839eff2c26674d83.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=2&desc=T恤"  target="_blank">
                    <img data-original="files/data0/web/2db3b66d556b48d28e86c508baf70d71.jpg" width="1200" height="280" alt="" />
                </a>
                <a href="/goods/queryList?type=2&desc=POLO衫"  target="_blank">
                    <img data-original="files/data0/web/5e01717a0bf44acfa3816fdc1709ddba.jpg" width="1200" height="280" alt="" />
                </a>
            </div>
        </div>
    </div>
