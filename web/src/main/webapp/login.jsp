...
<div class="bd_bottom_ea">
    <div class="wrap pub_logo_box clearfix">
        <div class="pub_logo f_l"><a href="/"><img alt="" src="pc/www/img/logo.png?v=biyao_4637d54"></a></div>
        <div class="f_r">
            <ul class="sizeZero merchant_info_box">
                <li class="inline mg_l40 mg_t40">
                    <span class="inline col_8c8">欢迎来到必要，请 </span><span class="col_8c8 inline mg_l5">登录 </span><span class="col_8c8 mg_l5 mg_r5 inline">|</span><a class="col_8c8 inline" href="register.jsp?returnUrl=index.html">注册</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="loginItem auto ">
        <form class="loginBox" method="post" action="/login">
            ...
            <dl class="mg_t20 sizeZero none" id="authCode">
                ...
                <dd class="inline mg_r20"><img src="pc/common/img/grey.gif?v=biyao_e3e994b" height="45" width="120" id="imgVCode" /></dd>
            ...
            <dl class="mg_t20 w400 relative">
                ...
                <dd class="inline">
                    ...
                    <a href="list.html#findpwd/index?returnUrl=index.html" class="inline col_link boxR">忘记密码</a>
                </dd>
            </dl>
            <dl class="mg_t10">
...
<script type="text/javascript">
    ...
    function register(){
        parent.window.open('register.jsp?returnUrl='+parent.window.location.href);
    }
    function findpwd(){
